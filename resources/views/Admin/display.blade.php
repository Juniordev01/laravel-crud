                                   ...
                                   <form action="{{url('date_filter')}}" method="POST">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                          <label>Min</label>
                                          <input class="form-control" name='start_date' placeholder="YYYY-MM-DD." type="date">
                                        </div>
                                        <div class="form-group text-right col-md-6">
                                          <label>Max</label>
                                          <input class="form-control" name='end_date' placeholder="YYYY-MM-DD." type="date">
                                        </div>
                                        </div>  
                                        <div class="d-flex">
                                            <button  class="highlight-button btn btn-medium button xs-margin-bottom-five" type="submit" >Apply Now</button>
                                        <a href="#" class="highlight-button btn btn-medium button xs-margin-bottom-five" data-abc="true">Reset</a>
                                        </div>
                                   </form>
                                </div>  
                            </div>
